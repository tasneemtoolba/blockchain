...
class Blockchain(object):
    ...
    def __init__(self, _genesisBlock, account):
        ...
        self.nodes = set()
        self.myAccount = {'Address': account['Address'], 'Weight': account['Weight'], 'Age': 0}
        try:
...
def main():
    ...
    account5 = {'Address': 'account5', 'Weight': 100}
    ...
    clients = [blockchain5, blockchain, blockchain2, blockchain3]
    ...
    blockchain3.add_new_node(blockchain)
    blockchain3.add_new_node(blockchain2)
